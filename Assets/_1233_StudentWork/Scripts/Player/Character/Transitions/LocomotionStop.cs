...
namespace Assets._1233_StudentWork.Scripts.PlayerCharacter.Transitions {
	class LocomotionStop : FSM_TransitionMeta<Character_MX02, PlayerCharacterInput> {
		new public static Type[] From => new Type[] { typeof(Locomoting), typeof(Landed) };
		new public static Type To => typeof(Idling);
